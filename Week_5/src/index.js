...
//function showTc(event) {
//  event.preventDefault();
//  let cTOut = document.querySelector("#temper");
//  cTOut.innerHTML = "17";
//}

//let cTemp = document.querySelector("#cT");
//cTemp.addEventListener("click", showTc);

//function showTf(event) {
//  event.preventDefault();
//  let cTOut = document.querySelector("#temper");
//  cTOut.innerHTML = "63";
//}

//let fTemp = document.querySelector("#fT");
//fTemp.addEventListener("click", showTf);
